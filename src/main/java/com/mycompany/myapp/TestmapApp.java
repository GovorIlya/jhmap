...
public class TestmapApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(TestmapApp.class);

    private final Environment env;

    public TestmapApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TestmapApp.class);
